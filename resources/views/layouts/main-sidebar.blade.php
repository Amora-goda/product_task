		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
                    ...
                    <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><span class="side-menu__label">Users</span><i class=" fe fe-users"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}"> users menu</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product-details') }}">Permisions</a></li>
						</ul>
					</li>
				</ul>
			</div>
